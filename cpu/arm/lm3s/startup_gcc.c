...
extern void SW_UARTStartBitDetect(void);
extern void SW_UARTSendNextBit(void);
extern void SW_UARTRcvNextBit(void);
//*****************************************************************************
//
...
void (* const g_pfnVectors[])(void) =
{
    ...
    SW_UARTSendNextBit,                      // Timer 1 subtimer A
    SW_UARTRcvNextBit,                      // Timer 1 subtimer B
    ...
    SW_UARTStartBitDetect,                      // GPIO Port G
...
FaultISR(void)
{
    ...
    // Enter an infinite loop.
    //
	// Print the fault through the Serial Port and Restart the system
	SysCtlReset();
    while(1)
    {
    }
